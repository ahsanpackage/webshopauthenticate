			   ...
			   <div class="panel-body">
			        <table class='table table-striped'>
			            ...
			            <tr>
			                ...
			                <td>
			                	<p>
									<a href="{{ URL::to(Config::get('webshopauthenticate::admin_uri').'/users/edit').'/'.$usr->user_id }}" title="{{ \Lang::get('webshopauthenticate::common.edit') }}">{{ \Lang::get('webshopauthenticate::common.edit') }} </a>
			                	</p>
                                @if($usr->activated)
                                    <a href="{{ URL::to(Config::get('webshopauthenticate::admin_uri').'/users/changestatus').'?action=deactivate&user_id='.$usr->user_id }}" class="fn_dialog_confirm red" action="De-Activate" title="{{ \Lang::get('webshopauthenticate::admin/manageMembers.memberlist_deactivate') }}">{{ \Lang::get('webshopauthenticate::admin/manageMembers.memberlist_deactivate') }} </a>
                                @else
                                    <a href="{{ URL::to(Config::get('webshopauthenticate::admin_uri').'/users/changestatus').'?action=activate&user_id='.$usr->user_id }}" class="fn_dialog_confirm green" action="Activate" title="{{ \Lang::get('webshopauthenticate::admin/manageMembers.memberlist_activate') }}">{{ \Lang::get('webshopauthenticate::admin/manageMembers.memberlist_activate') }} </a>
                                @endif
                            </td>
			           	</tr>
			            @endforeach
